...
for i in range(len(DATA_day0_optomotor_distX)):
    plt.plot(DATA_day0_optomotor_distX[i],DATA_day0_optomotor_distY[i])
...
plt.title("Optomotor: Gregarious")
#plt.title("Optomotor")
...
fig = plt.figure(figsize=(4,4),dpi=300)
ax = fig.add_subplot(111)
for i in range(len(DATA_day1_optomotor_distX)):
    plt.plot(DATA_day1_optomotor_distX[i],DATA_day1_optomotor_distY[i])
...
ax.boxplot([DATA_day0_optomotor,DATA_day1_optomotor])
...
diffcon = []
for i in range(len(DATA_day0_optomotor)):
    diff = DATA_day1_optomotor[i]-DATA_day0_optomotor[i]
    diffcon.append(diff) 
...
ax.boxplot([DATA_day0_optomotor_dist,DATA_day1_optomotor_dist])
    
plt.ylim(0,max([*DATA_day0_optomotor_dist,*DATA_day1_optomotor_dist]))
#plt.xlim(-30,30)
...
ax.boxplot([DATA_day0_optomotor_tort,DATA_day1_optomotor_tort])
